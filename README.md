...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.28.0" />
 </ItemGroup>
```
---
# .NET Framework
...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.28.0" GeneratePathProperty="true" ExcludeAssets="all"/>
 </ItemGroup>
```
---
