...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.28.4" />
 </ItemGroup>
```
---
# .NET Framework
...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.28.4" GeneratePathProperty="true" ExcludeAssets="all"/>
 </ItemGroup>
```
---
