...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.0.12" />
 </ItemGroup>
```
---
# .NET Framework
...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.0.12" GeneratePathProperty="true" ExcludeAssets="all"/>
 </ItemGroup>
```
---
