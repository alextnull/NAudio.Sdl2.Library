...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.0.14" />
 </ItemGroup>
```
---
# .NET Framework
...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.0.14" GeneratePathProperty="true" ExcludeAssets="all"/>
 </ItemGroup>
```
---
