...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.30.0" />
 </ItemGroup>
```
---
# .NET Framework
...
```xml
 <ItemGroup>
  <PackageReference Include="NAudio.Sdl2.Library" Version="2.30.0" GeneratePathProperty="true" ExcludeAssets="all"/>
 </ItemGroup>
```
---
